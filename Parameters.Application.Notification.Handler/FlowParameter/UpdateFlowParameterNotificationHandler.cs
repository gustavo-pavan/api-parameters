...
public class UpdateFlowParameterNotificationHandler : INotificationHandler<UpdateFlowParameterNotificationCommand>
{
    ...
    public UpdateFlowParameterNotificationHandler(IIntegrationEventService service, ILogger<UpdateFlowParameterNotificationHandler> logger, ILogger<UpdateFlowParameterIntegrationHandler> loggerIntegration)
    {
        _service = service;
        _logger = logger;
