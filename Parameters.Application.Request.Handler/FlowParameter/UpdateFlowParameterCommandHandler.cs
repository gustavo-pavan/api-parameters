...
public class UpdateFlowParameterCommandHandler : IRequestHandler<UpdateFlowParameterUpdateRequestCommand, FlowParameterEntity>
{
    ...
    public async Task<FlowParameterEntity> Handle(UpdateFlowParameterUpdateRequestCommand flowParameterUpdateRequest, CancellationToken cancellationToken)
    {
        try
        {
            ...
            var flowParameter = new FlowParameterEntity(flowParameterUpdateRequest.Id, flowParameterUpdateRequest.Name,
                FlowEnumeration.FromValue<FlowType>(flowParameterUpdateRequest.FlowType), flowParameterUpdateRequest.Description);
